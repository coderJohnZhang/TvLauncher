...
public interface KeyCode
{
	...
	public static final int KEY_F3 = KeyEvent.KEYCODE_F3;
	public static final int KEY_F4 = KeyEvent.KEYCODE_F4;
	...
	public static final int KEY_ANDROID = KeyEvent.KEYCODE_A;/*For APP List*/
	public static final int KEY_ORANGE = KeyEvent.KEYCODE_O;/*For Orange Key*/
	public static final int KEY_SETTINGS = KeyEvent.KEYCODE_SETTINGS;/*For STB Settings*/
	
	/* for V43 rcu */
	public static final int KEY_VOCAL_TRACT = KeyEvent.KEYCODE_MUSIC;
	public static final int KEY_VOLUME_MUTE = KeyEvent.KEYCODE_VOLUME_MUTE;
	public static final int KEY_CH_BACK = KeyEvent.KEYCODE_AVR_INPUT;
	public static final int KEY_POUND = KeyEvent.KEYCODE_POUND;

	public static final int KEY_AUDIO = 210;
	public static final int KEY_PAUSE = KeyEvent.KEYCODE_P;
	public static final int KEY_ZOOM = 212;
	public static final int KEY_INFO = 213;
	public static final int KEY_USALS = 214;
	public static final int KEY_AZ = 215;
	public static final int KEY_MOUSE = 230;
	//harry add 
	public static final int KEY_MOUSE_3796 = 1184;
